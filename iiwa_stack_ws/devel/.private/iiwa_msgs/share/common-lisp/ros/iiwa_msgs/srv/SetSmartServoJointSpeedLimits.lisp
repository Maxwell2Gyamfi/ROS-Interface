...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetSmartServoJointSpeedLimits-request>)))
  ...
  (cl:format cl:nil "# This service allows to set relative joint velocity and acceleration of the robot at runtime.~%# Set a parameter to -1 to ignore it~%~%# Relative velocity of the individual joints, 0.0 < value <= 1~%float64 joint_relative_velocity~%~%# Relative acceleration of the individual joints, 0.0 < value <= 1.0~%float64 joint_relative_acceleration~%~%# Override the acceleration factor for all joints. Must be between 0.0 and 10.0. ~%float64 override_joint_acceleration~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetSmartServoJointSpeedLimits-request)))
  "Returns full string definition for message of type 'SetSmartServoJointSpeedLimits-request"
  (cl:format cl:nil "# This service allows to set relative joint velocity and acceleration of the robot at runtime.~%# Set a parameter to -1 to ignore it~%~%# Relative velocity of the individual joints, 0.0 < value <= 1~%float64 joint_relative_velocity~%~%# Relative acceleration of the individual joints, 0.0 < value <= 1.0~%float64 joint_relative_acceleration~%~%# Override the acceleration factor for all joints. Must be between 0.0 and 10.0. ~%float64 override_joint_acceleration~%~%~%~%"))
