...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetWorkpiece-request>)))
  ...
  (cl:format cl:nil "# This service allows to attach a workpiece to the robots tool.~%# Setting a new workpiece automatically detaches the old one.~%~%# Id of Sunrise workpiece template. Leave emtpy to detach current workpiece.~%string workpiece_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetWorkpiece-request)))
  "Returns full string definition for message of type 'SetWorkpiece-request"
  (cl:format cl:nil "# This service allows to attach a workpiece to the robots tool.~%# Setting a new workpiece automatically detaches the old one.~%~%# Id of Sunrise workpiece template. Leave emtpy to detach current workpiece.~%string workpiece_id~%~%~%"))
